  ...
  createFile:function(){
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function (fs) {
        fs.root.getFile(fileData.path(), { create: true, exclusive: false }, function (fileEntry) {
            fileData.export(fileEntry, '[]');// fileEntry.name == 'someFile.txt' // fileEntry.fullPath == '/someFile.txt'
    ...
    fileEntry.file(function (file) {
        ...
        reader.onloadend = function() {
            try{
              ...
              glAllData = [{"x":"-0.0464","y":"-0.1597","z":"-9.6624","xG":"0.0064","yG":"0.0095","zG":"0.1426","a":"325.5719","b":"0.99","g":"-0.31","real":{"cx":"304.5512166","cy":"492.2817608","distance":"578.8719854"},"img":"img/i7pkmwp.png"},
            {"x":"-0.0464","y":"-0.1597","z":"-9.6624","xG":"0.0064","yG":"0.0095","zG":"0.1426","a":"325.5719","b":"0.99","g":"-0.31","real":{"cx":"304.5512166","cy":"492.2817608","distance":"578.8719854"},"img":"img/i7pkmwp.png"}];
              //glAllData = [];
            }
          //   glAllData = [{"x":"-0.0464","y":"-0.1597","z":"-9.6624","xG":"0.0064","yG":"0.0095","zG":"0.1426","a":"325.5719","b":"0.99","g":"-0.31","real":{"cx":"304.5512166","cy":"492.2817608","distance":"578.8719854"},"img":"img/i7pkmwp.png"},
          // {"x":"-0.0464","y":"-0.1597","z":"-9.6624","xG":"0.0064","yG":"0.0095","zG":"0.1426","a":"325.5719","b":"0.99","g":"-0.31","real":{"cx":"304.5512166","cy":"492.2817608","distance":"578.8719854"},"img":"img/i7pkmwp.png"}];
            ...
            try{
              document.getElementById('originalPicture').src ='data:image/jpeg;base64,'+glAllData[glAllData.length-1]['img'];
            }
            catch(e){
            ...
            try{
              ...
              if(glAllData.length>0){
                for(var i=0;i<glAllData.length;i++){
                  text+=DOMfileBlock(glAllData[i],i);
                }
              }
              else{
...
function fileCalculate(){
  var range = getRange(glAllData);
  var re    = remap(glAllData,range);
  var plat  = document.getElementById('2d_canvas');
  var poly  = document.getElementById('3d_canvas');
  var height= getCeilingHeight(define_height,glAllData[0]['real']['distance'],glAllData[1]['b']);
  draw2D(plat.getContext('2d'),plat,re);
  draw3D(poly,glAllData,height);
}
